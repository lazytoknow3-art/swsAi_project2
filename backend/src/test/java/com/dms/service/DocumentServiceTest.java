...
class DocumentServiceTest {
    ...
    @Test
    void uploadSingle_validPdf_succeeds() throws Exception {
        ...
        assertDoesNotThrow(() -> documentService.uploadSingle(file, "user1"));
        verify(documentRepository, times(1)).save(any());
    }

    @Test
    void uploadSingle_nonPdf_throwsInvalidFileException() {
        MockMultipartFile file = new MockMultipartFile(
                "file", "test.txt", "text/plain", new byte[1024]);

        assertThrows(InvalidFileException.class, () -> documentService.uploadSingle(file, "user1"));
        verifyNoInteractions(storageService);
    }

    @Test
    void uploadSingle_emptyFile_throwsInvalidFileException() {
        MockMultipartFile file = new MockMultipartFile(
    ...
    @Test
    void uploadSingle_oversizedFile_throwsInvalidFileException() {
